...
### 1. download the source from qt.io

### 2. check the configure options:
[xzhao@brl-sim01 src_files]$ `cd qt-everywhere-src-5.15.3/`
[xzhao@brl-sim01 qt-everywhere-src-5.15.3]$ `./configure -h`
```
+ cd qtbase
+ /home/xzhao@vulcanforms.com/src_files/qt-everywhere-src-5.15.3/qtbase/configure -top-level -h
...
* also see the help docs: https://doc.qt.io/qt-5/configure-options.html
```
$ mkdir qt5-build
$ cd qt5-build
$ ../qt5/configure -developer-build -opensource -nomake examples -nomake tests -release -optimize-size -opensource -recheck-all -platform linux-g++ -c++std c++11 -gui no
```
- compilers option:  `-platform linux-g++`
